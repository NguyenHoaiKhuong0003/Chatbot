...
export const useChatHistory = () => {
  ...
  const archiveChat = useCallback(async (chatId) => {
    ...
    try {
      ...
      await saveUserActivity('archive_chat', { chatId });
    } catch (error) {
      console.error('❌ Lỗi khi lưu trữ chat:', error);
      throw error;
    }
  }, [currentUser, saveUserActivity]);
  ...
  const unarchiveChat = useCallback(async (chatId) => {
    ...
    try {
      ...
      await saveUserActivity('unarchive_chat', { chatId });
    } catch (error) {
      console.error('❌ Lỗi khi bỏ lưu trữ chat:', error);
      throw error;
    }
  }, [currentUser, saveUserActivity]);
  ...
  useEffect(() => {
    ...
    const setupSubscriptions = async () => {
      ...
      try {
        ...
        unsubscribeArchived = onSnapshot(archivedQ, (snapshot) => {
          ...
          console.error('❌ Lỗi khi lấy archived chats:', error);
        });
      } catch (error) {
